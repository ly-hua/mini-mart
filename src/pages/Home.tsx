...
const Home: React.FC = () => {
  ...
  return (
    <main className="flex-grow w-full pb-8 md:pb-16 pt-2 md:pt-4">
      {/* 1. Hero Banner */}
      <div className="mb-6 md:mb-12 px-2 md:px-3">
        <HeroBanner />
      </div>
      ...
      <div className="mt-4 max-w-[1400px] mx-auto px-2 md:px-3">
        <div className="w-full border-b border-gray-100 pb-2 mb-4">
          <div className="flex flex-col lg:gap-6 lg:flex-row lg:items-end lg:justify-between">
            <div className="flex flex-col gap-2 sm:gap-4">
              <h2 className="text-lg md:text-xl font-bold text-gray-900 border-l-4 border-[#00A651] pl-4">Daily Essentials</h2>
            </div>
          </div>
        </div>
